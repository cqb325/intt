        ...
        return (
            <div>
                ...
                <Form method="ajax" layout="stack-inline">
                    ...
                    <FormControl label="CheckBox" type="checkbox" name="checkbox" data={[{id: "1", text: "Iphone"},{id: "2", text: "Android"}]}/>
                    <FormControl label="Radio" type="radio" name="radio" data={[{id: "1", text: "Iphone"},{id: "2", text: "Android"}]}/>
                    <FormControl label="Select" type="select" name="select" data={[{id: "1", text: "Iphone"},{id: "2", text: "Android"}]}/>
                ...
                <IconButton style={{fontSize: 15}} icon="save"></IconButton>

                <Logo></Logo>

                <MessageBox title="Tip" msg="msgContent" ref="msg"></MessageBox>
                ...
                <Pagination current={1} total={1000} pageSize={10}></Pagination>
                ...
                <Spin.WaterSpin size={100} percent={50}></Spin.WaterSpin>
