...
`reqNum`  int(4) NULL DEFAULT NULL ,
`schema`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL ,
PRIMARY KEY (`id`),
...
`ct_time`  datetime NULL DEFAULT NULL ,
`extend_mock`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL ,
PRIMARY KEY (`id`)
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
